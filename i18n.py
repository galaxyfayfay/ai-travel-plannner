...
TRANSLATIONS = {
    "EN": {
        ...
        "day_prefs_caption": "Customise each day — area, rating filter, and place count.",
        "area_label": "Area",
        ...
        "map_caption": "Tap a circle to see details · Tap a route dot for travel info",
        "budget_heading": "💰 Cost Estimate (per person)",
        "budget_over": "🔴 A few days exceed your budget. Try fewer stops or nearby areas.",
        ...
        "rec_caption": "Worth exploring — didn't fit the main itinerary.",
        "rec_refresh": "🔄",
        "welcome_1_icon": "🎯",
        ...
        "welcome_3_desc": "Cluster nearby places automatically",
        "welcome_4_icon": "🗺️",
        ...
        "warn_demo_data": "⚠️ Showing sample data — live data unavailable.",
        "data_source": "📡 Data",
    ...
    "ZH": {
        ...
        "warn_demo_data": "⚠️ 暂时无法获取实时数据，当前显示示例地点。",
        "data_source": "📡 数据来源",
